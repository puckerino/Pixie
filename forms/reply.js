(function($){
  ...
  $(function(){
    ...
    $('.fa-generated-reply-form').each(function(){
      ...
      function getTopicId(){
        const field = $form.data('topic-field');
        ...
        return parseInt($form.data('topic'), 10) || 0;
      }
